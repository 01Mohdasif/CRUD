...
function Read() {
  ...
  function setDataToStorage(id, name, email, phoneNumber, donationAmount, createdDate, PANNo, subscribeNewsLetter) {
                ...
                return (
                  <>
                    <tr key={index}>
                      ...
                      <td>{item.PANNo}</td>
                      <td>{item.subscribeNewsLetter}</td>
                      <td>
                        <Link to="/edit">
                          <button
